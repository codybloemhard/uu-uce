...
fun getFiles (
    ...
    if (serverURL == "") {
        Toast.makeText(
            activity,
            activity.getString(R.string.contentservices_noserver),
            Toast.LENGTH_LONG
        ).show()
    ...
    if (!wifiManager!!.isWifiEnabled && !networkDownloadAllowed) {
        Toast.makeText(
            activity,
            activity.getString(R.string.contentservices_nowifi_downloadblock),
            Toast.LENGTH_LONG
        ).show()
        onCompleteAction(false)
        return
    ...
    activity.runOnUiThread {
        Toast.makeText(
            activity,
            activity.getString(R.string.contentservices_downloading),
            Toast.LENGTH_SHORT
        ).show()
    }
