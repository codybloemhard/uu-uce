...
abstract class UceRoomDatabase : RoomDatabase() {
    ...
    private class UceDatabaseCallback(private val scope: CoroutineScope) : RoomDatabase.Callback() {
        ...
        suspend fun populateDatabase(pinDao: PinDao) {
            ...
            pinList.add(PinData(3, "31N46715335N3134680E", 3, "MCQUIZ", "Quiz pin", "[{\"tag\":\"MCQUIZ\", \"mc_correct_option\" : \"Right\", \"mc_incorrect_option\" : \"Wrong\" , \"mc_correct_option\" : \"Also right\", \"mc_incorrect_option\" : \"Also wrong\"}]", 1, "-1", "2"))
