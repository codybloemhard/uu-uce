...
abstract class UceRoomDatabase : RoomDatabase() {
    ...
    private class UceDatabaseCallback(private val scope: CoroutineScope) : RoomDatabase.Callback() {
        ...
        suspend fun populateDatabase(pinDao: PinDao) {
            ...
            val pin1 = PinData(0, 0, "31N3149680N46777336E", 1, "TEXT" , "testPin1", "[{\"tag\":\"TEXT\", \"text\":\"test\"}]", 1, "-1", "-1")
            val pin2 = PinData(0, 1, "31N3133680N46718336E", 2, "IMAGE", "testPin2", "[{\"tag\":\"IMAGE\", \"file_name\":\"test.png\"}]", 1, "-1", "-1")
            val pin3 = PinData(0, 2, "31N3130000N46710000E", 3, "VIDEO", "testPin3", "[{\"tag\":\"VIDEO\", \"file_name\":\"zoo.mp4\", \"thumbnail\":\"zoothumbnail.png\", \"title\":\"zoo video\"}]", 0, "1", "-1")
